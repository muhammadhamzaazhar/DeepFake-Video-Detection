...
//                       <button
//                         onClick={resetForm}
//                         className="btn-outline text-gray-700 flex-1 flex items-center justify-center"
//                       >
...
//                         <div className="inline-flex items-center space-x-4 text-sm text-slate-500 dark:text-slate-400 bg-slate-100/50 dark:bg-slate-800/50 px-4 py-2 rounded-full">
...
//                     <button
//                       onClick={resetForm}
//                       className="w-full bg-gradient-to-r from-slate-600 to-slate-700 hover:from-slate-700 hover:to-slate-800 text-white font-semibold py-4 px-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 flex items-center justify-center space-x-3"
//                     >
//                       <Upload size={20} />
...
//                   description:
//                     "Comprehensive analysis with confidence scores and detailed authenticity assessment.",
//                   icon: Shield,
