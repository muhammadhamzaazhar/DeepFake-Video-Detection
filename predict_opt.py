...
if __name__ == "__main__":
    ...
    try:
        ...
        root_dir = "video_processing_outputs_optical"
        ...
        print(f"{Fore.GREEN}[SUCCESS] Saved {len(optical_thumbnails)} optical thumbnails to {thumbnails_dir}{Style.RESET_ALL}")
        ...
        folder_path = r'./video_processing_outputs_optical/thumbnails' 
